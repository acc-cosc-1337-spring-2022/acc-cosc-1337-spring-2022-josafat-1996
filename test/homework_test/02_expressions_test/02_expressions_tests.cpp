...
//   Create an assertion to verify that calling the get_sales_tax_amount function with parameter    
//   20 returns the value 1.35.
TEST_CASE("Test Get Sales Taxes")
{
...
{
	REQUIRE(get_tip_amount(20.0, 15.0) == 3);
	REQUIRE(get_tip_amount(20.0, 20.0) == 4);
}
